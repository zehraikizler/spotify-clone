const HomeIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      className="Svg-sc-1bi12j5-0 hDgDGI home-active-icon"
      viewBox="0 0 24 24"
    >
      <path
...
const PrevIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      class="Svg-sc-1bi12j5-0 hDgDGI TAwjQ24UpWZGFAfa7bQ3"
      viewBox="0 0 24 24"
    >
      <path
...
const DownDirIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      class="Svg-sc-1bi12j5-0 hDgDGI uTkQAMWL5SHXimdorVLl"
      viewBox="0 0 16 16"
    >
